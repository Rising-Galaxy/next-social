  ...
  return (
    <div className="">
      ...
      <div className="flex items-center gap-4">
        <Image
          src="https://images.pexels.com/photos/29326451/pexels-photo-29326451.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
          alt=""
          width={32}
          height={32}
      ...
      <div className="">
        ...
        <div className="flex gap-4 justify-between mt-6">
          ...
          <div className="flex flex-col gap-2 flex-1">
            ...
            <p>
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eligendi tempora ipsum incidunt cum voluptate corrupti,
              omnis pariatur voluptates, ratione saepe error ea, blanditiis minus vitae quibusdam illo voluptas unde
              necessitatibus.
            </p>
